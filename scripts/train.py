...
def parse_args():
    ...
    ap.add_argument("--experiment-name", default="anomaly-detection-experiments", help="Name of the MLflow experiment")
...
def main():
    ...
    U.log_run_to_mlflow(params=params, metrics=metrics, artifacts=artifacts, run_name=name, experiment_name=args.experiment_name)
